...
describe("default", function()
    ...
    it("works if a flag argument is used where a value is expected", function()
        local parser = _make_style_parser()
        assert.same({ "lowercase" }, parser:get_completion("--style low"))
    end)
end)
...
describe("named argument", function()
    describe("++foo=bar", function()
        ...
        it("auto-completes on a #partial argument name - 001", function()
            ...
            assert.same({ "--help" }, parser:get_completion("--s", 1))
            assert.same({ "--help" }, parser:get_completion("--s", 2))
        ...
        it("auto-completes on a #partial argument name - 002", function()
            ...
            assert.same({ "--foo=" }, parser:get_completion("--foo=appl", 4))
            assert.same({ "--foo=apple", "--foo=apply" }, parser:get_completion("--foo=appl", 7))
        ...
        it("auto-completes on a #partial argument value - 001", function()
            ...
            assert.same({ "++style=" }, parser:get_completion("++style=lowercase", 1))
            assert.same({ "++style=" }, parser:get_completion("++style=lowercase", 3))
            assert.same({ "++style=" }, parser:get_completion("++style=lowercase", 7))
            assert.same({ "++style=" }, parser:get_completion("++style=lowercase", 8))
            ...
            assert.same({ "++style=lowercase" }, parser:get_completion("++style=lowercase", 16))
        end)
    ...
    it("auto-completes on a #partial argument name - 001", function()
        ...
        assert.same({ "--style=", "--help" }, parser:get_completion("--s", 1))
        assert.same({ "--style=", "--help" }, parser:get_completion("--s", 2))
    end)

    it("auto-completes on a #partial argument name - 002", function()
        local parser = _make_style_parser()

        assert.same({ "--style=", "--help" }, parser:get_completion("--styl", 1))
        assert.same({ "--style=", "--help" }, parser:get_completion("--styl", 2))
    ...
    it("auto-completes on a #partial argument name - 003", function()
        ...
        assert.same({ "--style=", "--help" }, parser:get_completion("--style", 1))
        assert.same({ "--style=", "--help" }, parser:get_completion("--style", 2))
    ...
    it("auto-completes on a #partial argument value - 001", function()
        ...
        assert.same({ "--style=lowercase" }, parser:get_completion("--style=low"))
        assert.same({ "--style=", "--help" }, parser:get_completion("--style=lowercase", 1))
        assert.same({ "--style=" }, parser:get_completion("--style=lowercase", 3))
        assert.same({ "--style=" }, parser:get_completion("--style=lowercase", 7))
        assert.same({ "--style=" }, parser:get_completion("--style=lowercase", 8))
        assert.same({ "--style=lowercase" }, parser:get_completion("--style=lowercase", 9))
    ...
    it("does not auto-complete if the name does not match", function()
        ...
        assert.same({ "--repeat=", "--help" }, parser:get_completion("--style=", 1))
        assert.same({ "--repeat=", "--help" }, parser:get_completion("--style=", 2))
...
describe("flag argument", function()
    ...
    it("does not auto-complete if at the end of the flag - 001", function()
        ...
        assert.same({ "-f=", "--help" }, parser:get_completion("-f", 1))
    ...
    describe("++flag examples", function()
        ...
        it("does not auto-complete if at the end of the flag - 001", function()
            ...
            assert.same({ "+f=" }, parser:get_completion("+f", 1))
            assert.same({ "+f=" }, parser:get_completion("+f", 2))
        end)
    end)
end)
